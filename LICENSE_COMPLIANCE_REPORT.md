...
| composer/spdx-licenses | 1.6.0 | MIT | ✅ Compatible |
| composer/xdebug-handler | 3.0.5 | MIT | ✅ Compatible |
...
| duosecurity/duo_universal_php | 1.2.0 | BSD-3-Clause | ✅ Compatible |
...
| ezimuel/php-secure-session | dev-composer-update | BSD-3-Clause | ✅ Compatible |
...
| illuminate/container | v10.49.0 | MIT | ✅ Compatible |
| illuminate/contracts | v10.49.0 | MIT | ✅ Compatible |
| illuminate/filesystem | v10.49.0 | MIT | ✅ Compatible |
| illuminate/macroable | v10.49.0 | MIT | ✅ Compatible |
...
| neitanod/forceutf8 | v2.0.4 | BSD-3-Clause | ✅ Compatible |
| nesbot/carbon | 2.73.0 | MIT | ✅ Compatible |
...
| psr/event-dispatcher | 1.0.0 | MIT | ✅ Compatible |
| psr/http-client | 1.0.3 | MIT | ✅ Compatible |
| psr/http-factory | 1.1.0 | MIT | ✅ Compatible |
| psr/http-message | 2.0 | MIT | ✅ Compatible |
| psr/log | 3.0.2 | MIT | ✅ Compatible |
| psr/simple-cache | 3.0.0 | MIT | ✅ Compatible |
| ralouphie/getallheaders | 3.0.3 | MIT | ✅ Compatible |
| ratchet/rfc6455 | v0.3.1 | MIT | ✅ Compatible |
| react/cache | v1.2.0 | MIT | ✅ Compatible |
| react/dns | v1.14.0 | MIT | ✅ Compatible |
| react/event-loop | v1.6.0 | MIT | ✅ Compatible |
| react/promise | v3.3.0 | MIT | ✅ Compatible |
| react/socket | v1.17.0 | MIT | ✅ Compatible |
| react/stream | v1.4.0 | MIT | ✅ Compatible |
| robthree/twofactorauth | v2.1.0 | MIT | ✅ Compatible |
| seld/jsonlint | 1.12.1 | MIT | ✅ Compatible |
...
| teampassclasses/encryption | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/folderservices | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/importformat | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/language | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/ldapextra | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/nestedtree | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/oauth2controller | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/passwordgeneratorservice | dev-composer-update | GPL-3.0-only | ✅ Compatible |
| teampassclasses/passwordmanager | dev-composer-update | GPL-3.0-only | ✅ Compatible |
...
| Package | Version | License | Status |
|---------|---------|---------|--------|
| jQuery | 3.x | MIT | ✅ Compatible |
| AdminLTE | 3.x | MIT | ✅ Compatible |
| Bootstrap | 4.x | MIT | ✅ Compatible |
| DataTables | 1.x | MIT | ✅ Compatible |
| Font Awesome | 5.x | CC BY 4.0, SIL OFL 1.1 | ⚠️ Review |
...
⚠️ **Status:** Some licenses require manual review
