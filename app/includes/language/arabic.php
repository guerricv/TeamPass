...
$LANG = array(
    ...
    'lapr_account_paused_rotation_blocked' => 'تم تعليق عمليات التدوير التلقائي لهذا الحساب. استخدم إعادة الضبط والاستئناف قبل بدء عملية تدوير جديدة.',
    'lapr_endpoint_checks_enabled_setting' => 'فحص الخوادم المسجلة دوريًا',
    'lapr_endpoint_check_interval_setting' => 'الفاصل الزمني لفحص الخوادم (بالدقائق)',
    'lapr_check_endpoint' => 'فحص الخادم وتحديث المعلومات',
    'lapr_endpoint_check_success' => 'يمكن الوصول إلى الخادم، ومعلومات نظام التشغيل محدثة، وصلاحيات التدوير صالحة.',
    'lapr_endpoint_check_reachable_no_rights' => 'يمكن الوصول إلى الخادم، لكن حساب SSH لم يعد قادرًا على تنفيذ عمليات تدوير كلمات المرور.',
    'lapr_endpoint_check_already_running' => 'يوجد بالفعل فحص قيد الانتظار أو التنفيذ لهذا الخادم.',
    'lapr_pause_endpoint' => 'إيقاف عمليات التدوير التلقائي مؤقتًا',
    'lapr_pause_endpoint_notice' => 'سيتم إيقاف عمليات التدوير التلقائي ومحاولات الإعادة المعلقة لهذا الخادم. سيتم الاحتفاظ بحالات الحسابات وتواريخ الاستحقاق؛ وستظل فحوصات الخادم غير المتلفة مفعلة.',
    'lapr_pause_reason' => 'السبب المسجل في سجل التدقيق',
    'lapr_pause_reason_maintenance' => 'صيانة مخططة',
    'lapr_pause_reason_incident' => 'حادث أو تجميد أمني',
    'lapr_pause_reason_access_change' => 'تغيير SSH أو صلاحيات الوصول',
    'lapr_pause_reason_operator' => 'طلب المشغل',
    'lapr_resume_endpoint' => 'استئناف عمليات التدوير التلقائي',
    'lapr_resume_endpoint_confirm' => 'سيتحقق TeamPass أولًا من اتصال SSH وصلاحيات التدوير. سيظل الخادم متوقفًا مؤقتًا إذا فشل الفحص. هل تريد المتابعة؟',
    'lapr_resume_endpoint_success' => 'نجح فحص الخادم وتم استئناف عمليات التدوير التلقائي.',
    'lapr_resume_endpoint_failed' => 'تظل عمليات التدوير التلقائي متوقفة مؤقتًا. طبّق المعالجة المقترحة ثم حاول الاستئناف مرة أخرى.',
    'lapr_resume_due_accounts' => 'حل موعد التدوير بالفعل لعدد #count# من الحسابات المُدارة وستصبح مؤهلة عند التشغيل التالي للمجدول.',
    'lapr_endpoint_status_paused' => 'عمليات التدوير متوقفة مؤقتًا',
    'lapr_endpoint_paused' => 'عمليات التدوير التلقائي متوقفة مؤقتًا لهذا الخادم',
    'lapr_endpoint_already_paused' => 'عمليات التدوير التلقائي متوقفة مؤقتًا بالفعل لهذا الخادم.',
    'lapr_endpoint_not_paused' => 'هذا الخادم غير متوقف مؤقتًا.',
    'lapr_endpoint_paused_confirmation_required' => 'هذا الخادم متوقف مؤقتًا. أكّد صراحةً عملية التدوير اليدوي الطارئة قبل المتابعة.',
    'lapr_endpoint_paused_rotation_warning' => 'عمليات التدوير التلقائي متوقفة مؤقتًا لهذا الخادم. عملية التدوير اليدوي هذه إجراء طارئ صريح ولا تستأنف الخادم.',
    'lapr_rotation_cancelled_endpoint_paused' => 'أُلغيت عملية التدوير لأن عمليات التدوير التلقائي لهذا الخادم كانت متوقفة مؤقتًا. لم يتم تغيير أي كلمة مرور.',
    'lapr_item_endpoint_paused' => 'عمليات التدوير التلقائي متوقفة مؤقتًا للخادم المرتبط؛ ولا يزال التدوير اليدوي الطارئ متاحًا.',
    'lapr_rotation_failure_email_subject' => 'فشل تدوير LAPR',
    'lapr_rotation_failure_email_body' => 'فشلت عملية تدوير كلمة مرور LAPR.<br><br>الخادم: <strong>#endpoint#</strong> (#hostname#)<br>حساب Linux: #username#<br>الخطأ: <code>#error_code#</code><br>المشغّل: #trigger#<br>الحالة: #state#<br>المحاولة التالية: #retry_at#<br><br><a href="#url#">فتح الحسابات المُدارة في TeamPass</a>',
    'lapr_alert_state_action_required' => 'يلزم تدخل المشغل',
    'lapr_alert_state_retry_scheduled' => 'تمت جدولة محاولة تلقائية جديدة',
    'lapr_alert_state_suspended' => 'تم تعليق عمليات التدوير التلقائي',
    'lapr_retry_scheduled_detail' => 'تمت جدولة المحاولة #current#/#max# في #date#',
    'lapr_last_error' => 'آخر خطأ',
    'email_tpl_lapr_rotation_failure' => 'فشل تدوير LAPR',
    'email_tpl_lapr_rotation_failure_desc' => 'يُرسل إلى مستلم تنبيهات LAPR الذي تم تكوينه بعد فشل تدوير كلمة المرور. يحتوي على بيانات وصفية تشغيلية فقط، ولا يحتوي مطلقًا على كلمة مرور.',
    'lapr_monitor_state_endpoint_paused' => 'متوقف مؤقتًا بواسطة الخادم',
    'lapr_monitor_endpoint_checks' => 'فحوصات الخوادم المسجلة',
    'lapr_monitor_endpoint_check_interval' => 'الفاصل الزمني لفحص الخوادم',
    'lapr_monitor_endpoint_checks_due' => 'الفحوصات المستحقة حاليًا',
    'lapr_monitor_endpoint_checks_overdue' => 'الفحوصات المتأخرة',
    'lapr_monitor_endpoint_checks_stale' => 'خوادم ذات بيانات فحص قديمة',
    'lapr_monitor_endpoint_checks_pending' => 'فحوصات الخوادم المعلقة',
    'lapr_monitor_endpoint_checks_running' => 'فحوصات الخوادم قيد التنفيذ',
    'lapr_monitor_endpoint_checks_failed_24h' => 'حالات فشل غير متوقعة لعملية الفحص (24 ساعة)',
    'lapr_monitor_endpoint_checks_oldest' => 'أقدم فحص أخير للخادم',
    'lapr_monitor_endpoint_checks_next' => 'فحص الخادم التالي المستحق',
    'lapr_monitor_endpoint_checks_disabled' => 'فحوصات الخوادم الدورية معطلة',
    'lapr_monitor_endpoint_checks_overdue_status' => 'فحوصات الخوادم متأخرة أو بياناتها قديمة',
    'lapr_monitor_issue_endpoint_paused' => 'تم إيقاف عمليات التدوير التلقائي مؤقتًا عن قصد لهذا الخادم.',
    'lapr_monitor_issue_endpoint_unreachable' => 'يتعذر الوصول حاليًا إلى الخادم المُدار.',
    'lapr_monitor_issue_endpoint_error' => 'يتطلب الخادم المُدار تدخل المشغل قبل أن تتمكن عمليات التدوير من الاستمرار.',
    'lapr_monitor_issue_endpoint_check_worker_failed' => 'فشلت عملية فحص خادم مسجل بشكل غير متوقع خلال آخر 24 ساعة.',
    'lapr_monitor_issue_endpoint_check_queue_stalled' => 'قائمة انتظار فحص الخوادم المسجلة متوقفة.',
    'lapr_monitor_issue_endpoint_checks_overdue' => 'يحتوي خادم مسجل واحد أو أكثر على بيانات فحص متأخرة أو قديمة.',
