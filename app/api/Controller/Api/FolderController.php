                ...
                if ((int) $userData['allowed_to_create'] !== 1) {
                    ...
                    try {
                        ...
                        $arrFolder = $folderModel->createFolder(
                            ...
                            isset($arrQueryStringParams['create_auth_without']) ? (int) $arrQueryStringParams['create_auth_without'] : null,
                            isset($arrQueryStringParams['edit_auth_without']) ? (int) $arrQueryStringParams['edit_auth_without'] : null,
